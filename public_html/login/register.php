...
<body>
  ...
  if (mysqli_num_rows($result) > 0 ) {
    ...
    echo("<script>alert('Sign up success, please log in!')</script>"); // notify user sign up was success
    echo("<script>window.location = 'index.php';</script>"); // redirect user to index page to log in
  }
